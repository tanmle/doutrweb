...
import sentStyles from '@/components/notifications/SentNotifications.module.css'; // Reuse tab styles
...
export default function NotificationsPage() {
    ...
    return (
        <div className={styles.container}>
            ...
            <div className={sentStyles.tabs}>
                <button
                    className={`${sentStyles.tab} ${activeTab === 'received' ? sentStyles.activeTab : ''}`}
                    onClick={() => setActiveTab('received')}
                >
                    Received
                </button>
                <button
                    className={`${sentStyles.tab} ${activeTab === 'sent' ? sentStyles.activeTab : ''}`}
